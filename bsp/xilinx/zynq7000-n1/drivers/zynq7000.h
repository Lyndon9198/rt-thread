...
#define ZYNQ_DDR_BASE                  0x00000000U
#define ZYNQ_DDR_SIZE                  0x40000000U

#define ZYNQ_UART0_BASE                0xE0000000U
#define ZYNQ_UART0_IRQ                 59

#define ZYNQ_GPIO_BASE                 0xE000A000U
#define N1_AXI_GPIO_BASE               0x41200000U
#define ZYNQ_GPIO_PIN_COUNT            118U
#define N1_AXI_GPIO_PIN_BASE           ZYNQ_GPIO_PIN_COUNT
#define N1_GPIO_PIN_COUNT              (ZYNQ_GPIO_PIN_COUNT + 2U)
