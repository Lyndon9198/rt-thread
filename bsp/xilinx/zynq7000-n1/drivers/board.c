...
#define ZYNQ_DMA_START        0x08000000U
#define ZYNQ_DMA_END          0x08200000U
#define ZYNQ_NORMAL_NOCACHE   (SHARED | AP_RW | DOMAIN0 | (1U << 12) | DESC_SEC | XN)

struct mem_desc platform_mem_desc[] =
{
    {0x00000000U, ZYNQ_DMA_START, 0x00000000U, NORMAL_MEM},
    {ZYNQ_DMA_START, ZYNQ_DMA_END, ZYNQ_DMA_START, ZYNQ_NORMAL_NOCACHE},
    {ZYNQ_DMA_END, 0x40000000U, ZYNQ_DMA_END, NORMAL_MEM},
